                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-block">
                            ...
                            <a class="btn btn-primary float-right" href="<?php echo base_url('restrita/categorias/core') ?>">Novo +</a>
                        </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($categorias as $categoria) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <i data-feather="link-2" class="mr-2 text-info"></i><?php echo $categoria->categoria_meta_link; ?>
                                                </td>
                                                <td>
                                                    <?php echo formata_data_banco_com_hora($categoria->categoria_data_criacao); ?>
                                                </td>
                                                <td>
                                                    <?php echo ($categoria->categoria_ativa == 1) ? '<span class="badge badge-success">Ativa</span>' : '<span class="badge badge-danger">Inativa</span>'; ?>
                                                </td>

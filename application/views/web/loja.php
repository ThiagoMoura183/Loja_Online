...
<div class="product-area pt-60 pb-50">
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="li-product-tab">
                    <ul class="nav li-product-menu">
                        <li><a class="active" data-toggle="tab" href="#Mais-Vendidos"><span>Mais Vendidos</span></a></li>
                        <li><a data-toggle="tab" href="#li-bestseller-product"><span>Novos Produtos (Em Breve)</span></a></li>
                        <li><a data-toggle="tab" href="#li-featured-product"><span>...</span></a></li>
                    </ul>
                </div>
        ...
        <div class="tab-content">
            <div id="Mais-Vendidos" class="tab-pane active show" role="tabpanel">
                <div class="row">
                    <div class="product-active owl-carousel">

                    <?php foreach($produtosDestaques as $prodDestaque) : ?>
                        
                        <div class="col-lg-12">
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="<?php echo base_url('produto/' . $prodDestaque->produto_meta_link )?>">
                                        <img src="<?php echo base_url('./uploads/produtos/' . $prodDestaque->foto_caminho)?>" alt="<?php echo word_limiter($prodDestaque->produto_nome,20) ?>">
                                    </a>
                                    <span class="sticker">UP</span>
                                </div>
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <h4><a class="product_name" href="<?php echo base_url('produto/' . $prodDestaque->produto_meta_link )?>"><?php echo word_limiter($prodDestaque->produto_nome,20) ?></a></h4>
                                        <div class="price-box">
                                            <span class="new-price"><?php echo 'R$&nbsp' . number_format($prodDestaque->produto_valor,2)?></span>
                                        </div>
                                    </div>
                                    <div class="add-actions">
                                        <ul class="add-actions-link">
                                            <li class="add-cart active"><a href="<?php echo base_url('produto/' . $prodDestaque->produto_meta_link )?>">Visualizar</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

                                                ...
                                                <div class="col-lg-12 align-center">
                                                    <div class="error-wrapper text-center ptb-50 pt-xs-20">
                                                        <div class="error-text">
                                                            <h1>404</h1>
                                                            <h2>Ops! Busca Não Encontrada</h2>
                                                            <p>Infelizmente não encontramos o produto que você está procurando.</p>
                                                        </div>
                                                        <div class="error-button">
                                                            <a href="<?php echo base_url('/') ?>">Voltar para Página Inicial</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
